...
import { getDirection, setDirection } from '../../utils/navUtil';
import { getDecodedTokeData, cleanLocalStorage } from '../../utils/jwtUtil';
  ...
  render() {
    ...
    return (
      <nav className="navbar fixed-top">
          ...
          <div className="user d-inline-block">
            <UncontrolledDropdown className="dropdown-menu-right">
              <DropdownToggle className="p-0" color="empty">
                <span className="name mr-1">{this.state.loginUser.first_name} {this.state.loginUser.last_name}</span>
                {/* <span>
              ...
              <DropdownMenu className="mt-3" right>
                ...
                <DropdownItem onClick={() => this.toggle()}>Reset Password</DropdownItem>
                <DropdownItem divider />
        ...
        <ResetPasswordModal toggle={this.toggle} is_modalopen={this.state.modal} loginUser={this.state.loginUser} ></ResetPasswordModal>
      </nav>
    );
  }
}
