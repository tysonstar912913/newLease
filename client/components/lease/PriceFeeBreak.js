...
class PriceFeeBreak extends Component {
    ...
    render() {
        ...
        let total_design_review_fee = 0;
        if (this.props.total_design_review_fee) {
            total_design_review_fee = parseFloat(this.props.total_design_review_fee);
        }
                    ...
                    <Colxx xxs="12">
                        <div className="card mb-5">
                            <div className="card-body">
                                ...
                                <p>Total Design Review Fees: {total_design_review_fee}</p>
